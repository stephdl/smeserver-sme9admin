...
if [ -d /var/lib/sme9admin ]
then
    mv /var/lib/sme9admin /var/lib/sme9admin.old
    echo -e "Backup of the existing rrds directory :\t[OK]"
fi

mkdir -p /var/lib/sme9admin/
...
rrdtool create /var/lib/sme9admin/hd.rrd -s 300 \
...
rrdtool create /var/lib/sme9admin/if_loc.rrd -s 300 \
...
rrdtool create /var/lib/sme9admin/if_ext.rrd -s 300 \
    DS:bin:GAUGE:600:0:U \
    DS:bout:GAUGE:600:0:U \
    DS:pin:GAUGE:600:0:U \
    DS:pout:GAUGE:600:0:U \
...
rrdtool create /var/lib/sme9admin/cpu.rrd -s 300 \
    DS:total:GAUGE:600:0:U \
...
rrdtool create /var/lib/sme9admin/mem.rrd -s 300 \
...
rrdtool create /var/lib/sme9admin/httpd.rrd -s 300 \
...
rrdtool create /var/lib/sme9admin/samba.rrd -s 300 \
    DS:cpu:GAUGE:600:0:U \
    DS:mem:GAUGE:600:0:U \
    DS:nbproc:GAUGE:600:0:U \
    RRA:AVERAGE:0.5:1:12 \
...
rrdtool create /var/lib/sme9admin/afp.rrd -s 300 \
    DS:cpu:GAUGE:600:0:U \
    DS:mem:GAUGE:600:0:U \
    DS:nbproc:GAUGE:600:0:U \
    RRA:AVERAGE:0.5:1:12 \
...
rrdtool create /var/lib/sme9admin/squid.rrd -s 300 \
    DS:cpu:GAUGE:600:0:U \
    DS:mem:GAUGE:600:0:U \
    DS:nbproc:GAUGE:600:0:U \
    RRA:AVERAGE:0.5:1:12 \
...
rrdtool create /var/lib/sme9admin/sessions.rrd -s 300 \
